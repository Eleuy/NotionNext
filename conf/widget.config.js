...
module.exports = {
  ...
  WIDGET_PET_LINK:
    ...
    'https://github.com/imuncle/live2d/blob/master/live2d_3/model/Azue%20Lane(JP)/xianghe_2/xianghe_2.model3.json', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models
